'''
created on 29th Dec 2025
@author: yujia lu


In this version, label y is trajectories of EV. 


define by yourself about part marked with "!!!".
...
# def data_pre(divide_prop, read_dir_dp, if_test4DE=False):
#     sta_t = time.time()
